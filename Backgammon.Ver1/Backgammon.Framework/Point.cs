...
namespace Backgammon.Framework
{
    ...
    {
        public Point(int number, IPosition position, Direction direction, ConsoleColor colorOfCheckers, int numberOfCheckers)
        {
        ...
        public ConsoleColor ColorOfCheckers { get; set; }
